...
export default function TextBox(props) {
    ...
    function totalLength(){
        var input=document.getElementById("total_words");
        if(input==''){
            return 0;
        }
        else{
    ...
    return (
        <div style={{ color: props.mode === 'dark' ?'black' : 'white', backgroundColor: props.mode === 'dark' ? 'black' : 'white' }}>
            ...
            <div className="container my-3" style={{ color: props.mode === 'dark' ? 'white' : 'black', backgroundColor: props.mode === 'dark' ? 'black' : 'white' }}>
                ...
                <p id="total_words">{totalLength} words and {text.length} characters</p>
